"""
Django settings for hr_erp project.
...
TEST_MODE = True  # test mode yoqilgan
...
SECRET_KEY = 'django-insecure-ot+9o@upl@i8qmdv&je)27bfvz*q)-gf_6i24$_a1t%v5cvel5'
